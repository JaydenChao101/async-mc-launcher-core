...
4. Launching with authenticated credentials
...
class MicrosoftAuthenticator:
    ...
    async def get_valid_credentials(self) -> Optional[_types.Credential]:
        """
        Get valid Minecraft credentials, refreshing if necessary.
...
async def launch_with_microsoft_auth(minecraft_dir: str, version: str = "1.21.1"):
    ...
    credentials = await authenticator.get_valid_credentials()
